...
export default function Footer() {
  return (
    <footer className="bg-white dark:bg-[#1a1512] pt-20 pb-10 px-4 sm:px-10 border-t border-gray-100 dark:border-gray-800">
      ...
      <div className="max-w-[1280px] mx-auto pt-8 border-t border-gray-100 dark:border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-text-muted dark:text-gray-500">
